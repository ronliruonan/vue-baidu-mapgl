...
<template>
  <bmap-gl class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="15">
    <bmap-gl-circle :center="circlePath.center" :radius="circlePath.radius" stroke-color="blue" :stroke-opacity="0.5" :stroke-weight="2" @lineupdate="updateCirclePath" :editing="true"></bmap-gl-circle>
  </bmap-gl>
</template>
...
<doc-preview>
  <bmap-gl class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="15">
    <bmap-gl-circle :center="circlePath.center" :radius="circlePath.radius" @lineupdate="updateCirclePath" :editing="true"></bmap-gl-circle>
  </bmap-gl>
  <md-table>
    <md-table-header>
