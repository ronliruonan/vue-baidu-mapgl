...
```html
<template>
  <bmap-gl class="map" :center="{lng: 105.000, lat: 38.000}" :zoom="4">
    <bmap-gl-point-collection :points="points" shape="BMAP_POINT_SHAPE_STAR" color="red" size="BMAP_POINT_SIZE_SMALL" @click="clickHandler"></bmap-gl-point-collection>
  </bmap-gl>
</template>
...
<doc-preview>
  <bmap-gl class="map" @ready="addPoints" :center="{lng: 105.000, lat: 38.000}" :zoom="4">
    <bmap-gl-point-collection :points="points" shape="BMAP_POINT_SHAPE_STAR" color="red" size="BMAP_POINT_SIZE_SMALL" @click="clickHandler"></bmap-gl-point-collection>
  </bmap-gl>
</doc-preview>
</template>
