...
The `BmBoundary` component rendered by and inherits from the` bmap-gl-polygon` component.
...
```html
<bmap-gl class="map" :center="{lng: 116.403765, lat: 39.914850}" :zoom="11">
  <bmap-gl-boundary name="北京市海淀区" :strokeWeight="2" strokeColor="blue"></bmap-gl-boundary>
</bmap-gl>
```
...
<doc-preview>
<doc-preview>
  <bmap-gl class="map" :center="{lng: 109.49384, lat: 26.84204}" :zoom="11">
    <bmap-gl-boundary :name="name" :strokeWeight="2" strokeColor="blue"></bmap-gl-boundary>
  </bmap-gl>
  <md-table>
    <md-table-header>
