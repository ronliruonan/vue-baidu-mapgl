...
`BaiduMap` is a container of Baidu Map core class and instance. It's the root component of other components of *vue-bmap-gl*.\
...
```html
<template>
  <bmap-gl class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="15" :scroll-wheel-zoom="true">
  </bmap-gl>
</template>
```
...
```html
<template>
  <bmap-gl class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="15" :mapStyle="mapStyle">
  </bmap-gl>
</template>
<script>
export default {
...
```html
<template>
  <bmap-gl class="map" :center="{lng: 116.404, lat: 39.915}" :zoom="15" mapType="BMAP_SATELLITE_MAP">
  </bmap-gl>
</template>
```
...
#### Preview
<doc-preview>
  <bmap-gl class="map" :scroll-wheel-zoom="true" :center="center" :zoom="zoom" @moving="syncCenterAndZoom" @moveend="syncCenterAndZoom" @zoomend="syncCenterAndZoom">
  </bmap-gl>
  <md-table>
    <md-table-header>
